...
import com.api.connection.SongsRetrieval;
...
public class SongsTabFragment extends Fragment implements
		DownloadResultReceiver.Receiver {
	private View rootView;
	public static final String ARG_SECTION_NUMBER = "section_number";
	public final static String TAG = SongsTabFragment.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.songs_tab_fragment, container,
				false);
		...
		if (Connection.isConnectedToInternet(getActivity()
			...
			intent.putExtra("url", "http://modablaj.com/app/android/songs");
	...
	private void intializeProcess(String response) {
		SongsRetrieval songsRetrieval = new SongsRetrieval();
		if (songsRetrieval.GetMainAPI(response)) {
			List<Song> newSongs = songsRetrieval.getSongs();
